...
def make_data_loader(cfg, is_train=True, is_source=True,is_sarsource = False, is_distributed=False, start_iter=0):
    ...
    if is_train:
        if cfg.MODEL.DOMAIN_ADAPTATION_ON:
            if is_sarsource :
                dataset_list = cfg.DATASETS.SARSOURCE_TRAIN
            else:
                dataset_list = cfg.DATASETS.SOURCE_TRAIN if is_source else cfg.DATASETS.TARGET_TRAIN
        else:
            dataset_list = cfg.DATASETS.TRAIN
    else:
        dataset_list = cfg.DATASETS.TARGET_TEST if is_source else cfg.DATASETS.TEST
