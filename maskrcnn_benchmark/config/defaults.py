...
_C.MODEL.INVERSION_BACKBONE_ON = True
_C.MODEL.FEW_SHOT_ON = False
...
_C.DATASETS.SARSOURCE_TRAIN = ()
_C.DATASETS.TARGET_TRAIN = ()
_C.DATASETS.TARGET_TEST = ()
...
# DAIR options
# ---------------------------------------------------------------------------- #
_C.MODEL.INVERSION = CN()
_C.MODEL.INVERSION.RE_FEATURES_NUMS = 4
_C.MODEL.INVERSION.INVERSION_LOSS_WEIGHT = 0.001
_C.MODEL.INVERSION.DA_IMS_LEVEL_LOSS_WEIGHT = (1,1,1,1)
_C.MODEL.INVERSION.DROPOUT = True


_C.MODEL.FEW_SHOT = CN()
_C.MODEL.FEW_SHOT.RATIOS = (9//1)
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "./output/dior_unspuervise_1"
