...
class FastRCNNLossComputation(object):
    ...
    def subsample(self, proposals, targets):
        ...
        # proposals targets list[BoxList] 源域和目标域
        
        #  domain_labels [true false]  labels[源域和目标域各两千多个标签 目标域都是0]  regression_targets 源域和目标域[2000多个坐标]
