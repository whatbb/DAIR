...
class RPNLossComputation(object):
    ...
    def __call__(self, anchors, objectness, box_regression, targets):
        ...
        # 每一个archor对应一个labels regression_targets 一张图片大约对应两万多个archor label的意思是这一个archor中有没有物体 label为1代表这个archor代表一个目标框，label还有-1代表丢弃那些不符合的archor，0代表背景两种值 regression_targets负责回归离他最近的目标框的距离

        # labels中1的个数和sampled_pos_inds数量对应，但是都比targets中的框的数量多，这意味着一个框可能对应不止一个的labels为1
        ...
        #sampled_pos_inds sampled_neg_inds 加起来256个
